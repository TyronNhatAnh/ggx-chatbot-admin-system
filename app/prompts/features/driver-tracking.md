...
- check_driver_price(order_id, user_id, price_request) → calculate fare for driver (POST /guest/price/{orderId}).
...
- Driver fare calculation → check_driver_price(order_id, user_id, price_request).
