...
- get_branch_by_id(branch_id) / search_branches(keyword, organization_id) → branch records.
...
- B2B: validate_b2c_org_code(org_code), verify_biz_registration_number(biz_number).
